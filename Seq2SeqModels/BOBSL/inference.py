...
def combine_sequences_gt(all_interval_frames_test):
  combined_gt = []
  current_time = 1 # frame starts at 1
...
def main(config):
  ...
  data_loader = BOBSL_DataLoader1(
      ...
      '5130659699728866130', '6242043045785611181', '6186362230766820709', '6003446875091426252', '6240919482340977071', '6184988700225556709']},
  ...
  #test_loss = create_weighted_loss(class_weights, device) To add
 
  beam_width = 4
  # Beam search
  all_predictions, all_ground_truths, all_softmax_outputs = beam_search_inference(model, test_loader, device, beam_width, config.use_attention)
...
if __name__ == '__main__':
  parser = argparse.ArgumentParser(description='Inference on test data')
...
# run code
# python -m inference --use_attention # with attention
# python -m inference # wihtout attention
